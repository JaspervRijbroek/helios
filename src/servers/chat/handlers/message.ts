...
export default class MessageHandler extends AbstractHandler {
    ...
    handleMessage(client: ChatClient, packet: Element) {
        ...
        let channel = this.getRoom(packet.attrs.to);
        ...
        console.log(packet.children[1].children[0])
        channel.broadcastMessage(client, packet.getChildText('channel') || '', packet.getChildText('body') || '');
    }
}